...
class GameViewModel : ViewModel() {
    ...
    companion object {
        ...
        // This is the time at which the buzz should fire
        private const val COUNTDOWN_BUZZING_TIME = 10000L
    }
    ...
    private val _buzzEvent = MutableLiveData(BuzzType.NO_BUZZ)
    ...
    init {
        ...
        timer = object : CountDownTimer(COUNTDOWN_TIME, ONE_SECOND) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                if (millisUntilFinished <= COUNTDOWN_BUZZING_TIME)
